...
/**
 * TableModelForCMFolder
 * @author suhyun47.kim, sjh.yoo, hankido.lee
 * 
 */
public class TableModelForCMFolder extends MatchedInfoTableModel {
	...
	private FolderSummary mCodeMatchFolder = null;

	public TableModelForCMFolder() {
		setType("CodeMatchFolderTableModel");
	}

	public TableModelForCMFolder(FolderSummary pCodeMatchFolder) {
		mCodeMatchFolder = pCodeMatchFolder;
		setType("CodeMatchFolderTableModel");
	}
	
	
	public FolderSummary getCodeMatchFolder() {
		return mCodeMatchFolder;
	}

	public void setCodeMatchFolder(FolderSummary mCodeMatchFolder) {
		this.mCodeMatchFolder = mCodeMatchFolder;
	}
    ...
    public void setRowCount(int newRowCount) {
    	if(newRowCount == 0 && mCodeMatchFolder != null) {
    		this.mCodeMatchFolder.clear();
    	}
    }
    
	@Override
	public int getRowCount() {
		if(mCodeMatchFolder == null) return 0;
		return mCodeMatchFolder.getCodeMatchInforForFolderListSize();
	}

	@Override
	public Object getValueAt(int rowIndex, int columnIndex) {
		if(mCodeMatchFolder == null) return null;
		CodeMatchInfoForFolder tmpCodeMatchUnit = null;
		tmpCodeMatchUnit = mCodeMatchFolder.getCodeMatchFolderUnit(rowIndex);
