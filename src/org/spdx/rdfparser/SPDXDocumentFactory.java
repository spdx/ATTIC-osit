...
public class SPDXDocumentFactory {
	...
	public static SPDXDocument creatSpdxDocument(String fileNameOrUrl) throws IOException, InvalidSPDXAnalysisException {
		...
		return creatSpdxDocument(spdxRdfInput, figureBaseUri(fileNameOrUrl), fileType(fileNameOrUrl));
	}
	
	/**
	 * Encoding Treating
	 * 
	 * Date: 2013. 5. 22. ¿ÀÈÄ 12:30:31
	 * Author: ytaek.kim
	 * 
	 * Method Brief : 
	 * @param fileNameOrUrl
	...
	public static SPDXDocument creatSpdxDocument(InputStream input, String baseUri, String fileType) throws InvalidSPDXAnalysisException {
		Model model = ModelFactory.createDefaultModel();
